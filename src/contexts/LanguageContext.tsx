...
const translations = {
  sv: {
    ...
    'travel.transport.content': 'Bussar hämtar och lämnar vid Steam Hotel och Elite Stadshotellet. Se schemat för avgångstider.',
  ...
  en: {
    ...
    'travel.transport.title': 'Transport',
    'travel.transport.content': 'Buses will pick up and drop off at Steam Hotel and Elite Stadshotellet. See the schedule for departure times.',
  ...
  de: {
    ...
    'travel.transport.title': 'Transport',
    'travel.transport.content': 'Busse holen ab und bringen zurück zum Steam Hotel und Elite Stadshotellet. Abfahrtszeiten siehe Programm.',
