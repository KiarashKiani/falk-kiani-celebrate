...
const translations = {
  sv: {
    ...
    'travel.findus.transport.intro': 'Bussar hämtar och lämnar vid Steam Hotel och Elite Stadshotellet.',
    'travel.findus.transport.title': 'Avgångstider',
    'travel.findus.transport.friday.day': 'Fredag',
    'travel.findus.transport.friday.out': 'Utresa från hotellen ca kl 17.30 till Nybynäs Gård',
    'travel.findus.transport.friday.back': 'Hemresa tillbaka till hotellen senare på kvällen',
    'travel.findus.transport.saturday.day': 'Lördag',
    'travel.findus.transport.saturday.out': 'Utresa från hotellen ca kl 13.00 till Nybynäs Gård',
    'travel.findus.transport.saturday.back': 'Hemresa tillbaka till hotellen under natten',
  ...
  en: {
    ...
    'travel.findus.transport.intro': 'Buses pick up and drop off at Steam Hotel and Elite Stadshotellet.',
    'travel.findus.transport.title': 'Departure Times',
    'travel.findus.transport.friday.day': 'Friday',
    'travel.findus.transport.friday.out': 'Departure from hotels at approx. 5:30 PM to Nybynäs Gård',
    'travel.findus.transport.friday.back': 'Return to hotels later in the evening',
    'travel.findus.transport.saturday.day': 'Saturday',
    'travel.findus.transport.saturday.out': 'Departure from hotels at approx. 1:00 PM to Nybynäs Gård',
    'travel.findus.transport.saturday.back': 'Return to hotels during the night',
  ...
  de: {
    ...
    'travel.findus.transport.intro': 'Busse holen ab und bringen zurück zum Steam Hotel und Elite Stadshotellet.',
    'travel.findus.transport.title': 'Abfahrtszeiten',
    'travel.findus.transport.friday.day': 'Freitag',
    'travel.findus.transport.friday.out': 'Abfahrt von den Hotels ca. 17:30 Uhr nach Nybynäs Gård',
    'travel.findus.transport.friday.back': 'Rückfahrt zu den Hotels später am Abend',
    'travel.findus.transport.saturday.day': 'Samstag',
    'travel.findus.transport.saturday.out': 'Abfahrt von den Hotels ca. 13:00 Uhr nach Nybynäs Gård',
    'travel.findus.transport.saturday.back': 'Rückfahrt zu den Hotels in der Nacht',
