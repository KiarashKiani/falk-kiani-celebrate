...
const translations = {
  sv: {
    ...
    'timeline.saturday.ceremony.description': 'Bussen avgår från Elite och Steam Hotel 13.00',
    ...
    'timeline.dinner.description': 'Bröllopsmiddag serveras.',
    'timeline.dancing.title': 'Dans & Musik',
    'timeline.dancing.time': '22:00',
    'timeline.dancing.description': 'Dags att dansa!',
    ...
    'rsvp.plusOne.name.placeholder': 'Din +1s namn',
    'rsvp.email': 'E-post',
  ...
  en: {
    ...
    'timeline.saturday.ceremony.description': 'Bus departs from Elite and Steam Hotel at 1:00 PM',
    ...
    'timeline.dinner.description': 'Wedding dinner is served.',
    'timeline.dancing.title': 'Dancing & Music',
    'timeline.dancing.time': '10:00 PM',
    'timeline.dancing.description': 'Time to dance!',
    ...
    'rsvp.plusOne.name.placeholder': 'Your plus one\'s name',
    'rsvp.email': 'Email',
  ...
  de: {
    ...
    'rsvp.plusOne.name.placeholder': 'Name deiner Begleitung',
    'rsvp.email': 'E-Mail',
