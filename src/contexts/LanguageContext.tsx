...
const translations = {
  sv: {
    ...
    'travel.accommodation.content': 'Vi rekommenderar hotell i Västerås centrum. Clarion Collection Hotel Packhuset och Elite Stadshotellet Västerås är båda utmärkta alternativ.',
  ...
  en: {
    ...
    'travel.accommodation.content': 'We recommend hotels in Västerås city center. Clarion Collection Hotel Packhuset and Elite Stadshotellet Västerås are both excellent options.',
