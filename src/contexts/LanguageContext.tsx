...
const translations = {
  sv: {
    ...
    'timeline.friday.location': 'Vi samlas på Nybynäs Gård',
    'timeline.friday.food': 'Mat och dryck serveras.',
    'timeline.friday.end': 'Kvällen avslutas med bussar tillbaka till Västerås.',
    ...
    'timeline.saturday.ceremony.description': 'Häng med på välkomstdrink följt av vigseln där vi säger ja till varandra för alltid. Ta en stund att mingla, slappna av och fira starten av helgen med oss. Bussen avgår från Elite och Steam Hotel 13.00.',
    ...
    'timeline.dinner.description': 'Efter vigseln samlas vi för bröllopsmiddag med god mat, hjärtliga tal och delade stunder runt bordet. När middagen avslutas fortsätter festen.',
    'timeline.dancing.title': 'Dans & Musik',
    'timeline.dancing.time': '22:00',
    'timeline.dancing.description': 'När kvällen övergår till natt öppnas dansgolvet. Räkna med flödande drinkar, bra musik och ett firande som varar sent. Dags att dansa och släppa loss!',
  ...
  en: {
    ...
    'timeline.friday.location': 'We gather at Nybynäs Gård',
    'timeline.friday.food': 'Food and drinks will be served.',
    'timeline.friday.end': 'The evening ends with buses back to Västerås.',
    ...
    'timeline.saturday.ceremony.description': 'Join us for welcome drinks followed by the ceremony as we say yes to forever. Take a moment to mingle, settle in, and celebrate the start of the weekend with us. Bus departs from Elite and Steam Hotel at 13.00.',
    ...
    'timeline.dinner.description': 'After the ceremony, we gather for a wedding dinner filled with good food, heartfelt speeches, and shared moments around the table. When dinner winds down, the party continues.',
    'timeline.dancing.title': 'Dancing & Music',
    'timeline.dancing.time': '10:00 PM',
    'timeline.dancing.description': 'As the evening turns into night, the dance floor opens. Expect flowing drinks, great music, and a celebration that lasts late. Time to dance and let loose!',
  ...
  de: {
    ...
    'timeline.friday.location': 'Wir treffen uns auf Nybynäs Gård',
    'timeline.friday.food': 'Essen und Getränke werden serviert.',
    'timeline.friday.end': 'Der Abend endet mit Bussen zurück nach Västerås.',
    ...
    'timeline.saturday.ceremony.description': 'Der Bus fährt um 13:00 Uhr vom Elite und Steam Hotel ab.',
    ...
    'timeline.dinner.description': 'Hochzeitsessen wird serviert.',
    'timeline.dancing.title': 'Tanz & Musik',
    'timeline.dancing.time': '22:00 Uhr',
    'timeline.dancing.description': 'Zeit zum Tanzen!',
