...
const translations = {
  sv: {
    ...
    'timeline.saturday.ceremony.description': 'Häng med på välkomstdrink följt av vigseln där vi säger ja till varandra för alltid. Ta en stund att mingla, slappna av och fira starten av helgen med oss. Bussen avgår från Elite och Steam Hotel.',
  ...
  en: {
    ...
    'timeline.saturday.ceremony.description': 'Join us for welcome drinks followed by the ceremony as we say yes to forever. Take a moment to mingle, settle in, and celebrate the start of the weekend with us. Bus departs from Elite and Steam Hotel.',
