...
const translations = {
  sv: {
    ...
    'timeline.saturday.ceremony.description': 'Vigselceremonin hålls i den vackra äppellunden.',
  ...
  en: {
    ...
    'timeline.saturday.ceremony.description': 'The ceremony will be held in the beautiful apple orchard.',
  ...
  de: {
    ...
    'timeline.saturday.ceremony.description': 'Die Trauung findet im wunderschönen Apfelgarten statt.',
