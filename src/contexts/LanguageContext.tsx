...
const translations = {
  sv: {
    ...
    'travel.findus.transport': 'För er som bor på hotell i Västerås, kommer det finnas bussar till och från Nybynäs gård både på fredagen och lördagen. Specifika tider anges när det närmar sig.',
    ...
    'rsvp.attending.yes': 'Självklart, ses i juli!',
    'rsvp.attending.no': 'Tyvärr kan jag/vi inte vara med',
    'rsvp.names': 'Namn',
    ...
    'details.children.content': 'Era barn betyder mycket för oss men just den här helgen har vi valt att fira utan barn. Ammande spädbarn är självklart varmt välkomna.',
  ...
  en: {
    ...
    'travel.findus.transport': 'For those staying at hotels in Västerås, there will be buses to and from Nybynäs gård on both Friday and Saturday. Specific times will be announced closer to the date.',
    ...
    'rsvp.plusOne': 'If there are two of you on the invitation, please add the other name here',
    ...
    'details.children.content': 'Your children mean a lot to us, but for this weekend we have chosen to celebrate without children. Breastfeeding infants are of course very welcome.',
    'details.hashtag.title': 'Hashtag',
    ...
    'details.dresscode.friday.content': 'Summer chic. \nThe goal is to be outdoors if the weather allows. Keep in mind that evenings can get cool – feel free to bring an extra sweater or shawl.',
  ...
  de: {
    ...
    'travel.findus.transport': 'Für diejenigen, die in Hotels in Västerås übernachten, wird es am Freitag und Samstag Busse von und nach Nybynäs gård geben. Genaue Zeiten werden näher am Datum bekannt gegeben.',
    ...
    'rsvp.plusOne': 'Wenn ihr zu zweit eingeladen seid, tragt bitte den anderen Namen hier ein',
    ...
    'details.children.content': 'Eure Kinder bedeuten uns viel, aber für dieses Wochenende haben wir uns entschieden, ohne Kinder zu feiern. Stillende Säuglinge sind selbstverständlich herzlich willkommen.',
    'details.hashtag.title': 'Hashtag',
    ...
    'details.dresscode.friday.content': 'Sommerlich schick. \nDas Ziel ist es, draußen zu sein, wenn das Wetter es zulässt. Bedenkt, dass die Abende kühl werden können – bringt gerne einen extra Pullover oder Schal mit.',
