      ...
      <div className="max-w-6xl mx-auto px-6 border-[#fff8f0]">
        ...
        <div ref={fridayRef}>
          <div className="flex justify-center mb-24">
            <WavyCard visible={fridayVisible} delay="100ms" borderColor={colors.darkOlive} wavyPath={wavyPaths.card1} className="hover:-translate-y-1 transition-transform duration-500 max-w-xl w-full min-h-[280px]">
