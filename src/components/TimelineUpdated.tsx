...
const WavyCard = ({
  ...
  return <div className={`relative transition-all duration-700 ease-out ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"} ${className}`} style={{
    transitionDelay: visible ? delay : "0ms"
      ...
      <div className="relative z-10 h-full flex items-start justify-start p-8 md:p-10 pr-10 md:pr-12 pb-10 md:pb-12 my-px">
      ...
      <div className="max-w-6xl mx-auto px-6 border-[#fff8f0]">
        ...
        <div ref={saturdayRef}>
          ...
          <WavyCard
            ...
            className="hover:-translate-y-1 transition-transform duration-500 aspect-[4/5] md:aspect-square">
