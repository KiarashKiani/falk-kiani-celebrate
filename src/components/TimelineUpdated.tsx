...
const WavyCard = ({
  ...
  visible?: boolean;
  delay?: string;
}) => <div className={`relative transition-all duration-700 ease-out ${visible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-12"} ${className}`} style={{
  transitionDelay: visible ? delay : "0ms"
    ...
    <svg viewBox="0 0 200 240" className="absolute inset-0 w-full h-full" preserveAspectRatio="none">
      <path d="M15,25 
           ...
           Q0,205 15,185 Q30,165 15,145 Q0,125 15,105 Q30,85 15,65 Q0,45 15,25 Z" fill="none" className="stroke-wedding-olive" strokeWidth="2" />
    </svg>
...
const Timeline = () => {
  ...
  return <section id="timeline" className="py-20 bg-wedding-sage">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div ref={fridayRef}>
          ...
          <div className={`mb-20 transition-all duration-1000 ease-out ${fridayVisible ? "opacity-100 translate-y-0 scale-100" : "opacity-0 translate-y-8 scale-95"}`}>
