...
}: {part1: string;part2: string;andText?: string;color?: string;ochColor?: string;}) => {
  return <div>
  ...
  return <section id="timeline" className="pt-12 pb-28" style={{
    backgroundColor: colors.cream
      ...
      <div className="max-w-6xl mx-auto px-6 border-[#fff8f0]">
        ...
        {/* Saturday Section */}
        <div ref={saturdayRef}>
          <div className={`text-center mb-14 transition-all duration-700 ease-out overflow-visible ${saturdayVisible ? "opacity-100 translate-y-0" : "opacity-0 translate-y-6"}`}>
            <h3 className="font-lovely-may text-4xl md:text-5xl uppercase tracking-wide" style={{
            color: colors.textOlive
          }}>
              {t("timeline.saturday.day") || "Lördag"}
            </h3>
            <h4 className="font-brittany-heading text-3xl md:text-4xl font-extralight pb-2" style={{
            color: colors.textOlive
          }}>
